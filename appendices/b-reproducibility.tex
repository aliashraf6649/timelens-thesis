...
\section{Deployment}
The RAG service is deployed on a Kaggle T4 GPU and exposed to the mobile app through an
...
Production serving & Kaggle T4 GPU $+$ ngrok & FastAPI RAG service.\\
\bottomrule
\end{tabularx}
\end{table}
...
The detector is reproduced by running the training scripts in order
